...
public class MyInstanceIDListenerService extends FirebaseInstanceIdService implements Response.ErrorListener, Response.Listener<JSONObject> {
	...
	public void onErrorResponse(VolleyError error) {
		...
		JewelChatApp.appLog("MyInstanceIDListenerService Volley error:"+errorMessage);
